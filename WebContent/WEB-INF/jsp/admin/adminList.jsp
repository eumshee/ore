...
<body>
	<c:choose>
		<c:when test="${empty proList }">
			...
			<form id="frmUpdate" action="adminUpdate.do" method="post">
				<input type="hidden" id="code" name="code">
			</form>
			...
			<button type="button" id="sch" onclick="formSearch()">검색</button>
		...
		<c:otherwise>
			...
			<button type="button" onclick="location.href='adminList.do'">돌아가기</button>
			<button type="button" onclick="location.href='adminInsertForm.do'">상품등록</button>
			<br><br>
				<table class="table">
					<tr>
